...
function DiscountFareList({ navigation }) {
    ...
    return (
      <View style={{ flexDirection: "row", justifyContent: "space-around" }}>
        <FontAwesome
          ...
          color="green"
          onPress={() => {
            navigation.navigate("discountfareform", { tran_id: tran_id });
          }}
        />
      </View>
    );
  ...
  const Refresh = () => {
    postData("Masters/BrowseDiscountFare", param).then((data) => {
      setGrid(data);
      setloading(false);
    });
  };
  ...
  return (
    <View style={{ flex: 1 }}>
      ...
      <FAB
        ...
        icon="plus"
        onPress={() => {
          navigation.navigate("discountfareform");
        }}
      />    
    </View>
  );
...
export default DiscountFareList;
